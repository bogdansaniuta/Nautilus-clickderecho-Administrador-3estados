...
class AdminExtension(GObject.GObject, Nautilus.MenuProvider):
    ...
    def get_file_items(self, files):
        item = Nautilus.MenuItem(
            name='AdminOpen',
            label='Abrir como Administrador (con advertencia)',
            tip='Abrir esta ubicacion con permisos de administrador'
        )
    ...
    def get_background_items(self, current_folder):
        item = Nautilus.MenuItem(
            name='AdminOpenBg',
            label='Abrir como Administrador (con advertencia)',
            tip='Abrir esta carpeta con permisos de administrador'
        )
